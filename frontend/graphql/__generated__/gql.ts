...
type Documents = {
    ...
    "query ReviewDashboard($pageNumber: Int!, $resultsPerPage: Int!, $view: DashboardView) {\n  reviewDashboard(\n    pageNumber: $pageNumber\n    resultsPerPage: $resultsPerPage\n    view: $view\n  ) {\n    applicantRecordId\n    firstName\n    lastName\n    position\n    timesApplied\n    applicationStatus\n    choice\n    reviewers {\n      id\n      firstName\n      lastName\n      email\n      position\n      role\n      isArchived\n    }\n    totalScore\n  }\n}": typeof types.ReviewDashboardDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query ReviewDashboard($pageNumber: Int!, $resultsPerPage: Int!, $view: DashboardView) {\n  reviewDashboard(\n    pageNumber: $pageNumber\n    resultsPerPage: $resultsPerPage\n    view: $view\n  ) {\n    applicantRecordId\n    firstName\n    lastName\n    position\n    timesApplied\n    applicationStatus\n    choice\n    reviewers {\n      id\n      firstName\n      lastName\n      email\n      position\n      role\n      isArchived\n    }\n    totalScore\n  }\n}"): (typeof documents)["query ReviewDashboard($pageNumber: Int!, $resultsPerPage: Int!, $view: DashboardView) {\n  reviewDashboard(\n    pageNumber: $pageNumber\n    resultsPerPage: $resultsPerPage\n    view: $view\n  ) {\n    applicantRecordId\n    firstName\n    lastName\n    position\n    timesApplied\n    applicationStatus\n    choice\n    reviewers {\n      id\n      firstName\n      lastName\n      email\n      position\n      role\n      isArchived\n    }\n    totalScore\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
