...
type Documents = {
    ...
    "query InterviewDashboardSidePanel($applicantRecordId: ID!) {\n  interviewDashboardSidePanel(applicantRecordId: $applicantRecordId) {\n    firstName\n    lastName\n    term\n    program\n    position\n    resumeUrl\n    applicationStatus\n    skillCategory\n    isApplicantFlagged\n    isShortlistedForOffer\n    interviewers {\n      firstName\n      lastName\n    }\n    interview {\n      skill\n      passionFSG\n      teamPlayer\n      desireToLearn\n      comments\n    }\n    interviewStatus\n    interviewScore\n    interviewNotesId\n    interviewDate\n  }\n}": typeof types.InterviewDashboardSidePanelDocument,
    "query InterviewGroup($id: ID!) {\n  interviewGroup(id: $id) {\n    id\n    schedulingLink\n    status\n  }\n}": typeof types.InterviewGroupDocument,
    "query InterviewNotes($fileId: ID!) {\n  interviewNotes(fileId: $fileId) {\n    fileId\n    fileName\n    signedUrl\n  }\n}": typeof types.InterviewNotesDocument,
...
const documents: Documents = {
    ...
    "query InterviewDashboardSidePanel($applicantRecordId: ID!) {\n  interviewDashboardSidePanel(applicantRecordId: $applicantRecordId) {\n    firstName\n    lastName\n    term\n    program\n    position\n    resumeUrl\n    applicationStatus\n    skillCategory\n    isApplicantFlagged\n    isShortlistedForOffer\n    interviewers {\n      firstName\n      lastName\n    }\n    interview {\n      skill\n      passionFSG\n      teamPlayer\n      desireToLearn\n      comments\n    }\n    interviewStatus\n    interviewScore\n    interviewNotesId\n    interviewDate\n  }\n}": types.InterviewDashboardSidePanelDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query InterviewDashboardSidePanel($applicantRecordId: ID!) {\n  interviewDashboardSidePanel(applicantRecordId: $applicantRecordId) {\n    firstName\n    lastName\n    term\n    program\n    position\n    resumeUrl\n    applicationStatus\n    skillCategory\n    isApplicantFlagged\n    isShortlistedForOffer\n    interviewers {\n      firstName\n      lastName\n    }\n    interview {\n      skill\n      passionFSG\n      teamPlayer\n      desireToLearn\n      comments\n    }\n    interviewStatus\n    interviewScore\n    interviewNotesId\n    interviewDate\n  }\n}"): (typeof documents)["query InterviewDashboardSidePanel($applicantRecordId: ID!) {\n  interviewDashboardSidePanel(applicantRecordId: $applicantRecordId) {\n    firstName\n    lastName\n    term\n    program\n    position\n    resumeUrl\n    applicationStatus\n    skillCategory\n    isApplicantFlagged\n    isShortlistedForOffer\n    interviewers {\n      firstName\n      lastName\n    }\n    interview {\n      skill\n      passionFSG\n      teamPlayer\n      desireToLearn\n      comments\n    }\n    interviewStatus\n    interviewScore\n    interviewNotesId\n    interviewDate\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query InterviewNotes($fileId: ID!) {\n  interviewNotes(fileId: $fileId) {\n    fileId\n    fileName\n    signedUrl\n  }\n}"): (typeof documents)["query InterviewNotes($fileId: ID!) {\n  interviewNotes(fileId: $fileId) {\n    fileId\n    fileName\n    signedUrl\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation UpdateApplicantRecordIsApplicantFlagged($id: ID!, $flagValue: Boolean!) {\n  updateApplicantRecordIsApplicantFlagged(id: $id, flagValue: $flagValue) {\n    id\n    isApplicantFlagged\n  }\n}"): (typeof documents)["mutation UpdateApplicantRecordIsApplicantFlagged($id: ID!, $flagValue: Boolean!) {\n  updateApplicantRecordIsApplicantFlagged(id: $id, flagValue: $flagValue) {\n    id\n    isApplicantFlagged\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
