...
type Documents = {
    ...
    "query ReviewDashboard($pageNumber: Int!, $resultsPerPage: Int!, $sortBy: ReviewDashboardSortBy, $sortAscending: Boolean, $view: DashboardView) {\n  reviewDashboard(\n    pageNumber: $pageNumber\n    resultsPerPage: $resultsPerPage\n    sortBy: $sortBy\n    sortAscending: $sortAscending\n    view: $view\n  ) {\n    applicantRecordId\n    firstName\n    lastName\n    position\n    timesApplied\n    applicationStatus\n    choice\n    reviewers {\n      id\n      firstName\n      lastName\n      email\n      position\n      role\n      isArchived\n    }\n    totalScore\n  }\n}": typeof types.ReviewDashboardDocument,
    "query ReviewDashboardApplicantRecordIds($sortBy: ReviewDashboardSortBy, $sortAscending: Boolean) {\n  reviewDashboardApplicantRecordIds(\n    sortBy: $sortBy\n    sortAscending: $sortAscending\n  )\n}": typeof types.ReviewDashboardApplicantRecordIdsDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query ReviewDashboard($pageNumber: Int!, $resultsPerPage: Int!, $sortBy: ReviewDashboardSortBy, $sortAscending: Boolean, $view: DashboardView) {\n  reviewDashboard(\n    pageNumber: $pageNumber\n    resultsPerPage: $resultsPerPage\n    sortBy: $sortBy\n    sortAscending: $sortAscending\n    view: $view\n  ) {\n    applicantRecordId\n    firstName\n    lastName\n    position\n    timesApplied\n    applicationStatus\n    choice\n    reviewers {\n      id\n      firstName\n      lastName\n      email\n      position\n      role\n      isArchived\n    }\n    totalScore\n  }\n}"): (typeof documents)["query ReviewDashboard($pageNumber: Int!, $resultsPerPage: Int!, $sortBy: ReviewDashboardSortBy, $sortAscending: Boolean, $view: DashboardView) {\n  reviewDashboard(\n    pageNumber: $pageNumber\n    resultsPerPage: $resultsPerPage\n    sortBy: $sortBy\n    sortAscending: $sortAscending\n    view: $view\n  ) {\n    applicantRecordId\n    firstName\n    lastName\n    position\n    timesApplied\n    applicationStatus\n    choice\n    reviewers {\n      id\n      firstName\n      lastName\n      email\n      position\n      role\n      isArchived\n    }\n    totalScore\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query ReviewDashboardApplicantRecordIds($sortBy: ReviewDashboardSortBy, $sortAscending: Boolean) {\n  reviewDashboardApplicantRecordIds(\n    sortBy: $sortBy\n    sortAscending: $sortAscending\n  )\n}"): (typeof documents)["query ReviewDashboardApplicantRecordIds($sortBy: ReviewDashboardSortBy, $sortAscending: Boolean) {\n  reviewDashboardApplicantRecordIds(\n    sortBy: $sortBy\n    sortAscending: $sortAscending\n  )\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
