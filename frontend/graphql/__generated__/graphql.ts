...
export type InterviewDashboardQuery = { interviewDashboard: Array<{ applicantRecordId: string, firstName: string, lastName: string, position: string, applicationStatus: ApplicationStatus, interviewScore: number | null, interviewers: Array<{ id: string, firstName: string, lastName: string, email: string, position: string | null, role: Role, isArchived: boolean }> }> };
