...
const InterviewPageHeader = () => (
  <div className="flex flex-col gap-3">
    <Link href="/admin" className="font-source no-underline inline-flex justify-center items-center gap-2 w-fit cursor-pointer shrink-0 rounded-full py-2 px-4 border-2 border-blue bg-white text-blue text-base font-normal leading-[1.4] hover:opacity-90 hover:bg-sky-100" passHref>
        <LongLeftIcon />
        Back to home
    </Link>
