export const REVIEW_PFSG_SCORING_CRITERIA = [
  ...
  export const REVIEW_TP_SCORING_CRITERIA = [
  ...
  export const REVIEW_D2L_SCORING_CRITERIA = [
  ...
  export const REVIEW_SKL_SCORING_CRITERIA = [
